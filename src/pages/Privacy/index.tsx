    ...
    <MotionContainerStyled initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      ...
      <TextWrapper>
        ...
        <Paragraph>
          ...
          laws regarding processing of Personal Information may be less stringent than the laws in
        ...
        <Paragraph>
          ...
          Information from our databases. We recommend that children between the ages of 13 and 18
        ...
        <Paragraph>
          ...
          provide is automatically shared with others unless you tell PhotoDrop via your settings to
        ...
        <Paragraph>
          ...
          gender and other demographic information. We refer to such information as “Anonymous
          Information” because it cannot be used by itself to identify you and therefore is not
        ...
        <Paragraph>
          ...
          able to access and collect Personal Information about you and your friends that your
          privacy settings on the social network permit us to access. For instance, we may collect
        ...
        <Paragraph>
          ...
          you choose to sign up to receive information about products or services that may be of
        ...
        <Paragraph>
          ...
          procedures to help protect your Personal Information, including information derived from
        ...
        <Paragraph>
          ...
          manner. If you are a parent or guardian and believe that we might have inadvertently
        ...
        <Paragraph>
          ...
          use location information to improve and personalize our Service for you, such as to
          identify photos of you near a particular location. If you do not want us to collect
        ...
        <Paragraph>
          ...
          when you send an email notification to a friend through the Service or the social network
          from which you have connected to the Service (such as in an invitation, or when sharing
          your content). Additionally, we use your email address to contact you on behalf of your
          friends (such as when someone sends you a personal message) or notifications from a social
          network or other website with whom you have registered to receive such notifications. We
        ...
        <Paragraph>
          ...
          navigational data like Uniform Resource Locators (URL) to gather information regarding the
          date and time of your visit and the solutions and information for which you searched and
          viewed, or on which of the advertisements displayed on the Service you clicked. This type
          of information is collected to administer the Service, to make the Service more useful to
        ...
        <Paragraph>
          ...
          delete them) to tell us how and when you interact with our Services, to monitor aggregate
          usage and web traffic routing on our Service, to improve our Service, and to provide you
          with a more personal and interactive experience with the Service. Persistent Cookies can
          be removed by following your Internet browser help file directions. In order to use our
        ...
        <Paragraph>
          ...
          Web Beacons are used in order to deliver or communicate Cookies, to track and measure the
          performance of our Service, to monitor how many visitors view our Service, and to monitor
          information related to the effectiveness of served advertisements. Clicking on such
        ...
        <Paragraph>
          ...
          email, analyzing data, providing marketing assistance, processing payments (including
          credit card payments), quality control (such as manually or mechanically comparing
          reference images with photo matches to determine the accuracy of matches), creating
          biometric identifiers and providing customer service. We require our third-party service
          providers to promise not to use such information except as necessary to provide the
        ...
        <Paragraph>
          ...
          Privacy Policy does not cover the use of your Person Information by such third-parties. We
          do not maintain responsibility for the manner in which third parties, including, without
          limitation, social networks, other partners and advertisers, use or further disclose
          Personal Information collected from you in accordance with this Privacy Policy, after we
        ...
        <Paragraph>
          ...
          is necessary or appropriate to (a) comply with relevant laws and to stop any activity that
          we consider illegal, unethical, or legally actionable activity; (b) to respond to claims,
        ...
        <Paragraph>
          ...
          information you post or provide through the Service, such as your name, profile, comments,
          posts and ratings, may be shared with other users and posted on publicly available
          portions of the Service, including without limitation, chat rooms, bulletin and message
          boards, along with other public forums. Please keep in mind that if you choose to disclose
          Personal Information when posting comments or other information or content through the
          Service, this information may become publicly available and may be collected and used by
          others, including people outside the PhotoDrop community. We will not have any obligations
          with respect to any information that you post to parts of the Service available to others,
        ...
        <Paragraph>
          ...
          third party service is provided directly to the owner or operator of the third party
          website or service and is subject to the owner’s or operator’s privacy policy. We
          encourage our users to read the privacy statements of each and every website they visit
          and service they use. This Privacy Policy applies solely to information collected by us
          through the Service and does not apply to these third-party websites. The ability to
        ...
        <Paragraph>
          ...
          but please note that we may be required (by law or otherwise) to keep this information and
          not delete it (or to keep this information for a certain time, in which case we will
          comply with your deletion request, only after we have fulfilled such requirements). If you
          request deletion of your Account, we will delete photos you added to the Service, as well
        ...
        <Paragraph>
          ...
          use, or disclosure. When you enter sensitive information on our forms, we encrypt this
          data using SSL or other technologies. Even though we have taken significant steps to
        ...
        <Paragraph>
          ...
          we collect, use, or disclose your Personal Information, we will post an alert on this page
          and we’ll update the “Last Updated Date” above to indicate when those changes will become
          effective. If you object to any such changes, you must cease using the Service. Continued
